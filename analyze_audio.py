...
plt.tight_layout()
plt.savefig('images/analysis_waveforms.png', dpi=150, bbox_inches='tight')
print("Saved: images/analysis_waveforms.png")
plt.show()
...
plt.tight_layout()
plt.savefig('images/analysis_spectrograms.png', dpi=150, bbox_inches='tight')
print("Saved: images/analysis_spectrograms.png")
plt.show()
...
plt.tight_layout()
plt.savefig('images/analysis_mel_spectrograms.png', dpi=150, bbox_inches='tight')
print("Saved: images/analysis_mel_spectrograms.png")
plt.show()
...
plt.tight_layout()
plt.savefig('images/analysis_mfcc_statistics.png', dpi=150, bbox_inches='tight')
print("Saved: images/analysis_mfcc_statistics.png")
plt.show()
...
plt.tight_layout()
plt.savefig('images/feature_rms_energy.png', dpi=150, bbox_inches='tight')
print("Saved: images/feature_rms_energy.png")
plt.show()
plt.close()
...
plt.tight_layout()
plt.savefig('images/feature_zero_crossing_rate.png', dpi=150, bbox_inches='tight')
print("Saved: images/feature_zero_crossing_rate.png")
plt.show()
plt.close()
...
plt.tight_layout()
plt.savefig('images/feature_spectral_centroid.png', dpi=150, bbox_inches='tight')
print("Saved: images/feature_spectral_centroid.png")
plt.show()
plt.close()
...
plt.tight_layout()
plt.savefig('images/feature_spectral_rolloff.png', dpi=150, bbox_inches='tight')
print("Saved: images/feature_spectral_rolloff.png")
plt.show()
plt.close()
...
plt.tight_layout()
plt.savefig('images/feature_spectral_bandwidth.png', dpi=150, bbox_inches='tight')
print("Saved: images/feature_spectral_bandwidth.png")
plt.show()
plt.close()
...
plt.tight_layout()
plt.savefig('images/feature_chroma.png', dpi=150, bbox_inches='tight')
print("Saved: images/feature_chroma.png")
plt.show()
plt.close()
...
plt.tight_layout()
plt.savefig('images/feature_spectral_contrast.png', dpi=150, bbox_inches='tight')
print("Saved: images/feature_spectral_contrast.png")
plt.show()
plt.close()
...
print("  • images/feature_rms_energy.png")
print("  • images/feature_zero_crossing_rate.png")
print("  • images/feature_spectral_centroid.png")
print("  • images/feature_spectral_rolloff.png")
print("  • images/feature_spectral_bandwidth.png")
print("  • images/feature_chroma.png")
print("  • images/feature_spectral_contrast.png")
print("="*60)
